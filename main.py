...
def is_whitelisted_group(chat_id: int) -> bool:
    """التحقق إذا كانت المجموعة من المجموعات المعفاة"""
    return chat_id in WHITELISTED_GROUPS

async def require_subscription(message: Message):
    """التحقق من الاشتراك مع استثناء المجموعات البيضاء والمطور"""
    ...
    # التحقق إذا كانت المجموعة من المجموعات المعفاة
    if message.chat.type in ["group", "supergroup"] and is_whitelisted_group(chat_id):
        return True
    
    # باقي الحالات - التحقق من الاشتراك
...
"""
        ...
        # التحقق إذا كانت المجموعة من المجموعات المعفاة
        if chat_type in ["group", "supergroup"] and is_whitelisted_group(chat_id):
            commands_text = """
🔥 <b>FPI SX COMMAND</b> 🔥
...
"""
        ...
        # في المجموعات العادية - التحقق من الاشتراك مع أزرار
        ...
        # قائمة الأوامر الرئيسية للمستخدمين المشتركين
        commands_text = """
🔥 <b>FPI SX COMMAND</b> 🔥
